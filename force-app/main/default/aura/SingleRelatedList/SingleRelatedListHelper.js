({
    fetchData: function (cmp, event, helper) {
        console.log('INIT HELPER: ' + cmp.get("v.additionalFilter"))
                    console.log('INIT HELPER SORT : ' + cmp.get("v.columns"))
        ...
        var jsonData = JSON.stringify({fields:cmp.get("v.fields"),
                                       ...
                                       additionalFilter: cmp.get("v.additionalFilter")
        });
   ...
   initColumnsWithActions: function (cmp, event, helper) {
        ...
        var editButton = cmp.get('v.editButton');
        console.log('ACTIONS' + editButton);
    ...
    removeRecord: function (cmp, row) {
        ...
        $A.createComponents([
            ["c:SingleRelatedListDeleteRecordContent",{sobjectLabel:sobjectLabel}],
            ["c:SingleRelatedListDeleteRecordFooter",{record: row, sobjectLabel:sobjectLabel}]
        ],
